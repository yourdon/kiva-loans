...
* In this multiple-borrower class, we also notice a mild correlation between an indicator variable for a male presence in a group and the repayment rate. This is somewhat misleading. Males tend to be associated with higher-value loans, which tend to be paid back at a greater rate, but as we saw in a scatterplot, when we condition on the loan amount, males tend to be associated with a lower repayment rate.
