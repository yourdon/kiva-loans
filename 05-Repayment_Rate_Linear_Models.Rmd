...
So the root MSE is about 3.55 USD per day. Given that the mean repayment rate in our test set is 8.11 USD per day, this is not very good.
...
The error is 3.54 USD per day -- the same ballpark, in other words.
...
This is an improvement over the simple linear model, but the 22-feature model -- which did, in fact, inspect both countries and continents -- does better.
